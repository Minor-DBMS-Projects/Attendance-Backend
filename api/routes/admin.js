...
router.get('/add-user',(req, res, next)=>{
 ...
 {
   var classQuery="INSERT IGNORE INTO class(batch, program_id, class_group) VALUES (?, ?, ?)";
 ...
 router.get('/add-sub',(req, res)=>{
  ...
  router.post('/add-sub',(request,response)=>{
    ...
    var subjectQuery="INSERT IGNORE INTO subject(code, name, year, part, program_id) VALUES ?";
